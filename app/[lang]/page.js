...
export default async function Home({params}) {
  ...
  return (
    <>
      <div className="w-screen 2xl:w-[1536px] 2xl:mx-auto">
        <Navbar isActive="0" dict={t.navbar} />
        <div className="h-screen w-screen 2xl:w-[1536px] 2xl:m-auto overflow-x-hidden 2xl:overflow-x-visible relative home-page">
          <div className="px-6 sm:px-14 md:px-28 ">
            <div className="pt-48">
              <h1 className="text-text text-5xl font-bold card">
                {t.accueil.titre}
              </h1>
              <p className="pt-7 text-lg">{t.accueil.sous_titre}</p>
            ...
            <div className="absolute bottom-9 w-screen 2xl:w-[1536px] -ml-6 sm:-ml-14 md:-ml-28 flex justify-center">
        ...
        <div
          id="more"
          className="w-full bg-background  px-6 sm:px-14 md:px-28 pb-10 xl:pb-0 xl:h-screen"
        >
          <h2 className="title-h1 pt-48">{t.accueil.decouvrir}</h2>
          <div className="flex flex-col gap-10 xl:gap-0 items-center w-full 2xl:mt-32  xl:items-stretch xl:flex-row justify-between pt-10">
            <a href="/equipe">
              <div className="animate-card relative w-[350px] sm:w-96 bg-white px-6 pt-7 pb-7 xl:pb-0">
                ...
                <div className="flex flex-row xl:items-center justify-between pt-7 xl:pt-0 xl:flex-none">
                  ...
                  <div className="xl:absolute xl:bottom-10 xl:right-7 flex flex-row items-center gap-2">
                    ...
                    <Image src={arrow} height={16} width={9} />
                  </div>
                </div>
