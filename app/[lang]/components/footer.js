      ...
      <div className="bg-tertiary px-6 sm:px-14 md:px-28  py-10">
        <div className="w-full flex flex-col sm:flex-row items-center justify-between">
          <div className="flex flex-row items-center gap-8">
            <Image className="mr-10" src={logo_blanc} height={100} width={100} />
        ...
        <div className="pt-6 flex flex-col sm:flex-row w-full items-center justify-between text-card ">
          <p className="underline">contact@dleafinance.fr</p>
          <p className="italic text-sm">@2024 Alexandre Cresci. All right reserved</p>
        </div>
      </div>
    </>
  );
